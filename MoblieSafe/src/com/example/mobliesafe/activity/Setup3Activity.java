...
public class Setup3Activity extends BaseSetupActivity{
	...
	protected void initData() {
		super.initData();
		//回显安全号码
		et_safenumber.setText(SPUtils.getString(getApplicationContext(), MyContains.SAFENUMBER, ""));
	}
	...
	protected void startNext() {
		...
		if(TextUtils.isEmpty(safenumber)){
			...
			//有安全号码
			//保存安全号码到sp中
			SPUtils.putString(getApplicationContext(), MyContains.SAFENUMBER, safenumber);
